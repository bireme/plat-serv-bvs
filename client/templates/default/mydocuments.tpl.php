                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="doc-actions">
                                        <a class="label label-danger remove" href="<?=RELATIVE_PATH?>/controller/mydocuments/control/business/task/removedoc/document/<?=$register["docID"]?>/directory/<?=$register["dirID"]?>" onclick="__gaTracker('send','event','Favorite Documents','Remove Document','<?php echo $register["title"]; ?>');"><?php echo $trans->getTrans($_REQUEST["action"],'REMOVE_FROM_COLLECTION'); ?></a>
                                        <a class="label label-info move" href="javascript: void(0);" onclick="__gaTracker('send','event','Favorite Documents','Move Document','<?php echo $register["title"]; ?>'); window.open('<?=RELATIVE_PATH?>/controller/directories/control/business/task/movedoc/document/<?=$register["docID"]?>/directory/<?=$register["dirID"]?>','','resizable=no,width=420,height=270');"><?php echo $trans->getTrans($_REQUEST["action"],'MOVE_TO'); ?></a>
                                        <a class="label label-primary related-docs" href="javascript:;" onclick="__gaTracker('send','event','Favorite Documents','Related Documents','<?php echo $register["title"]; ?>');"><?php echo $trans->getTrans('suggesteddocs','RELATED_DOCS'); ?></a>
                                    </div>
                                    <!--div>
