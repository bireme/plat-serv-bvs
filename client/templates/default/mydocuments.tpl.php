                  ...
                  <div class="x_content">
                    <div class="folder-data col-md-9 col-sm-9 col-xs-12 col-list">
                        ...
                        <?if ($_REQUEST["directory"] != 0){?>
                            ...
                            <a href="javascript:;" class="public-link" data-toggle="modal" data-target=".bs-public-modal-lg" onclick="__gaTracker('send','event','Favorite Documents','Share Collection','<?php echo htmlspecialchars($resultDirName); ?>');"><span class="label"><i class="fa fa-share-alt fa-lg"></i><?=$trans->getTrans($_REQUEST["action"],'SHARE_COLLECTION')?></span></a>
                        <?}?>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="doc-actions">
                                        ...
                                        <a class="label label-primary related-docs" href="javascript:;" onclick="__gaTracker('send','event','Favorite Documents','Related Documents','<?php echo addslashes(htmlspecialchars($register["title"])); ?>');"><?php echo $trans->getTrans('suggesteddocs','RELATED_DOCS'); ?></a>
                                    </div>
                                    <!--div>
