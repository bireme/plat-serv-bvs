        ...
        <div class="box1 video-box">
            <div class="row">
                <div class="col s12 m12 l8 offset-l2 center-align">
                    <div class="box12">
                        <h6><b><?php echo $trans->getTrans('tutorial','MY_COLLECTION'); ?></b></h6>
                        <div class="video-container">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/rLaaq3vaz6s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
