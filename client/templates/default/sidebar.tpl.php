<aside id="aside" class="z-depth-4">
	...
	<nav id="nav">
		<div class="nav-wrapper">
			<ul class="">
				<li class="<?php echo ('menu' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/authentication"><i class="material-icons left">dashboard</i><span class="navtitulo"><?php echo $trans->getTrans('menu','HOME'); ?></span></a></li>
				<li class="<?php echo ('mydocuments' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/mydocuments/control/business"><i class="far fa-folder-open left"></i><span class="navtitulo"><?php echo $trans->getTrans('menu','MY_SHELF'); ?></span></a></li>
				<li class="<?php echo ('myprofiledocuments' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/myprofiledocuments/control/business"><i class="fas fa-folder left"></i><span class="navtitulo"><?php echo $trans->getTrans('menu','MY_PROFILE_DOCUMENTS'); ?></span></a></li>
				<li class="<?php echo ('mysearches' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/mysearches/control/business"><i class="fas fa-history left"></i><span class="navtitulo"><?php echo $trans->getTrans('menu','MY_SEARCHES'); ?></span></a></li>
	...
	<ul class="sidenav" id="mobile-demo">
		...
		<li class="<?php echo ('menu' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/authentication"><?php echo $trans->getTrans('menu','HOME'); ?></a></li>
		<li class="<?php echo ('mydocuments' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/mydocuments/control/business"><?php echo $trans->getTrans('menu','MY_SHELF'); ?></a></li>
		<li class="<?php echo ('myprofiledocuments' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/myprofiledocuments/control/business"><?php echo $trans->getTrans('menu','MY_PROFILE_DOCUMENTS'); ?></a></li>
		<li class="<?php echo ('mysearches' == $_REQUEST['action']) ? 'action' : ''; ?>"><a href="<?php echo RELATIVE_PATH; ?>/controller/mysearches/control/business"><?php echo $trans->getTrans('menu','MY_SEARCHES'); ?></a></li>
