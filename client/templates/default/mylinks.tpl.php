                  ...
                  <div class="x_content">
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <?php if ( $response["values"] != false ) : ?>
                            ...
                            <?php echo $objPaginator->render($trans->getTrans($_REQUEST["action"],'NEXT'), $trans->getTrans($_REQUEST["action"],'PREVIOUS')); ?>
                        <?php else : ?>
                            <p><?=$trans->getTrans($_REQUEST["action"],'MY_LINKS_NO_REGISTERS_FOUND')?></p>
                        <?php endif; ?>
                    </div>
                        ...
                        <section class="panel panel-folder">
                            <div class="panel-body">
                                ...
                                <ul class="list-docs-unstyled project_files">
                                    <li><a href="javascript: void(0);" onclick="window.open('<?=RELATIVE_PATH?>/controller/mylinks/control/view/task/add','','resizable=no,width=420,height=385')"><i class="fa fa-plus-circle"></i><?=$trans->getTrans($_REQUEST["action"],'ADD_LINK')?></a></li>
                                </ul>
                            </div>
                        </section>
                        <section class="panel panel-folder">
