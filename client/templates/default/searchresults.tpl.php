                                ...
                                <div class="col s12 m6">
                                    <div class="tituloDropdown"><?php echo $trans->getTrans($_REQUEST["action"],'FEED'); ?>: <b><?php echo $registerSearch["name"]; ?></b>
                                        ...
                                        <ul id='dropdown1' class='dropdown-content btn2Buttons'>
                                            <li><a href="#modal-ajax" class="modal-trigger modal-ajax" data-source="<?php echo RELATIVE_PATH; ?>/controller/searchresults/control/business/task/edit/rss/<?php echo $registerSearch["id"]; ?>" onclick="gtag('send','event','Search Results','Edit RSS','<?php echo htmlspecialchars($registerSearch["name"]); ?>');"><i class="far fa-edit right m1"></i> <?php echo $trans->getTrans($_REQUEST["action"],'EDIT_RSS'); ?></a></li>
                                            <li><a href="#modal-remove-rss" class="modal-trigger remove" data-source="<?php echo RELATIVE_PATH; ?>/controller/searchresults/control/business/task/delete/rss/<?php echo $registerSearch["id"]; ?>" data-title="<?php echo $registerSearch["name"]; ?>" onclick="gtag('send','event','Search Results','Remove RSS','<?php echo htmlspecialchars($resultDirName); ?>');"><i class="fas fa-eraser right m1"></i><?php echo $trans->getTrans($_REQUEST["action"],'REMOVE_RSS'); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col s12 m6">
                                    ...
                                    <div id="<?php echo 'doc'.$count; ?>" class="col s12">
                                        <div class="box1 hoverable">
                                            ...
                                            <div class="btn2Buttons">
                                                ...
                                                <?php endif; ?>
                                                <a href="#modal-related-docs" class="btn3 btnPrimary modal-trigger related-docs" onclick="gtag('send','event','Search Results','Related Documents','<?php echo addslashes(htmlspecialchars($item["title"])); ?>');"><?php echo $trans->getTrans('suggesteddocs','RELATED_DOCS'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
        ...
        <div class="box1 video-box">
            <div class="row">
                <div class="col s12 m12 l8 offset-l2 center-align">
                    <div class="box12">
                        <h6><b><?php echo $trans->getTrans('tutorial','FEED_RSS'); ?></b></h6>
                        <div class="video-container">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/Kl_MT6TulAU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
