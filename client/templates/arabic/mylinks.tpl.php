...
<div class="breadCrumb">
    <a href="/"><?=$trans->getTrans($_REQUEST["action"],'HOME')?></a>&gt; <?=$trans->getTrans($_REQUEST["action"],'MY_LINKS')?>
</div>
<div class="middle">
    <div class="content">
                        ...
                        <div class="articleBlock">
                            ...
                            <div class="actions">
                                ...
                                <?if ($register["inHome"] == true){?>
                                    <a class="inhome" href="<?=RELATIVE_PATH?>/controller/mylinks/control/business/task/notinhome/link/<?=$register["linkID"]?>"><img src="<?=RELATIVE_PATH?>/images/<?=$_SESSION["skin"]?>/removeFromHome.gif" border="0"/><?=$trans->getTrans($_REQUEST["action"],'HIDE_FROM_HOME')?></a>
                                <?}else{?>
                                    <a class="notinhome" href="<?=RELATIVE_PATH?>/controller/mylinks/control/business/task/inhome/link/<?=$register["linkID"]?>"><img src="<?=RELATIVE_PATH?>/images/<?=$_SESSION["skin"]?>/addToHome.gif" border="0"/><?=$trans->getTrans($_REQUEST["action"],'SHOW_IN_HOME')?></a>
                                <?}?>
                            </div>
                        </div>
                    </li>
