...
';
    ...
    // Terms of the menu pages
        ...
        self::$trans["menu"]["FEEDBACK_SERVICE"] = 'Enviar Comentario / Informar Error';
        ...
        self::$trans["menu"]["OER_NOT_FOUND"] = 'No se han encontrado recursos';
        self::$trans["menu"]["SEE_MORE"] = 'vea más';
        self::$trans["menu"]["MULTIMEDIA"] = 'Multimedia';
        self::$trans["menu"]["OER"] = 'Recursos Educativos Abiertos';
...
<h4>Sugerencias</h4>
<p>Los documentos que se muestran en este widget son sugerencias hechas desde el último documento visto en los servicios Documentos Favoritos o Temas de Interés.</p>
';
    ...
    // Tems of mydocuments pages
        ...
        self::$trans["mydocuments"]["SHARE"] = 'Compartir';
    ...
    // Tems of directories pages
        ...
        self::$trans["directories"]["MOVE_DOCUMENT_TO"] = 'para colección';
