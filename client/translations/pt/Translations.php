...
<h4>Sugestões</h4>
<p>Os documentos exibidos nesse widget são sugestões feitas a partir do último documento acessado nos serviços Documentos Favoritos ou Temas de Interesse.</p>
';
    ...
    // Tems of mydocuments pages
        ...
        self::$trans["mydocuments"]["SHARE"] = 'Compartilhar';
        ...
        self::$trans["mydocuments"]["SHARED_COLLECTION_DESC"] = "Coleção disponível nos Serviços Personalizados MinhaBVS - https://platserv.bvsalud.org";
