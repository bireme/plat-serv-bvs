...
';
    ...
    // Terms of orcidworks pages
        ...
        self::$trans["orcidworks"]["ORCID_WORKS_NO_REGISTERS_FOUND"] = 'Nenhuma publicação encontrada. Suas publicações são buscadas a partir do ORCID ID indicado no seu Perfil.';
