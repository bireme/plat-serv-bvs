...
<div class="fixed-action-btn">
	...
	<ul>
		<li><a href="<?php echo RELATIVE_PATH; ?>/controller/tutorial/control/business" class="btn-floating red tooltipped" data-position="left" data-tooltip="<?php echo TUTORIALS; ?>"><i class="material-icons">computer</i></a></li>
