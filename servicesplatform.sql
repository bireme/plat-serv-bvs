...
--
-- Estrutura da tabela `orcidGoogleScholar`
--

CREATE TABLE IF NOT EXISTS `orcidGoogleScholar` (
  `id` bigint(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `put_code` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `cited_url` varchar(1000) NOT NULL,
...
--
-- Estrutura da tabela `searchResults`
--
...
--
-- Estrutura da tabela `usersDeleted`
--

CREATE TABLE IF NOT EXISTS `usersDeleted` (
  `id` bigint(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `professional_area` varchar(100) NOT NULL DEFAULT '',
  `sysUID` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `userID` varchar(150) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `userAffiliation` varchar(100) DEFAULT '',
  `userDegree` varchar(100) NOT NULL DEFAULT '',
  `professionalArea` varchar(100) NOT NULL DEFAULT '',
  ...
  `last_login` datetime,
  `accept_mail` tinyint(1) NOT NULL DEFAULT '0',
